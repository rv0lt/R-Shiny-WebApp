  ...
  tabsetPanel(id="data",
              ...
              tabPanel('Coste laboral(en euros) por hora efectiva, comunidad autónoma, sectores de actividad', value="2",
                       sidebarPanel("Seleccione",
                                    ...
                                    downloadButton('downloadCSV_2', 'Descarga en CSV'),
                                    downloadButton("downloadRdata_2", 'Descarga en Rdata')
                       ),#SidebarPanel
                       mainPanel(strong("Datos extraídos del INE"),
              ...
              tabPanel('Número de vacantes comunidad autónoma', value="3",
                       sidebarPanel("Seleccione",
                                    ...
                                    downloadButton('downloadCSV_3', 'Descarga en CSV'),
                                    downloadButton("downloadRdata_3", 'Descarga en Rdata')
                       ),#SidebarPanel
                       mainPanel(strong("Datos extraídos del INE"),
              ...
              tabPanel('Motivos por los que no existen vacantes por comunidad autónoma', value="4",
                       sidebarPanel("Seleccione",
                                    ...
                                    downloadButton('downloadCSV_4', 'Descarga en CSV'),
                                    downloadButton("downloadRdata_4", 'Descarga en Rdata')
                       ),#SidebarPanel
                       mainPanel(strong("Datos extraídos del INE"),
